...
{
public:
  LiPkg(const std::string & frame_id = "base_scan");
  // Lidar spin speed (Hz)
...
{
public:
  LD00_LiPkg(const std::string & frame_id = "base_scan")
  : LiPkg(frame_id)
  {}
...
{
public:
  LD03_LiPkg(const std::string & frame_id = "base_scan")
    : LiPkg(frame_id)
  {}
...
{
public:
  LD08_LiPkg(const std::string & frame_id = "base_scan")
  : LiPkg(frame_id)
  {}
...
{
public:
  LD09_LiPkg(const std::string & frame_id = "base_scan")
  : LiPkg(frame_id)
  {}
